...
export function listGoogleChatAccountIds(cfg: OpenWolfConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenWolfConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenWolfConfig): ResolvedGoogleChatAccount[] {
