import type { ChannelOnboardingAdapter, OpenWolfConfig, WizardPrompter } from "openwolf/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.openwolf.ai/channels/mattermost",
    ].join("\n"),
