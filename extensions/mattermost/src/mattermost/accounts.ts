...
export function listMattermostAccountIds(cfg: OpenWolfConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenWolfConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenWolfConfig): ResolvedMattermostAccount[] {
