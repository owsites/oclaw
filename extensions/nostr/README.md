...
Nostr DM channel plugin for OpenWolf using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OpenWolf. It enables your bot to:
...
# Configure openwolf to use local relay
