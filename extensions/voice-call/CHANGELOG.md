...
- Version alignment with core OpenWolf release numbers.
...
- First public release of the @openwolf/voice-call plugin.
...
- CLI: `openwolf voicecall` commands (call/start/continue/speak/end/status/tail/expose).
