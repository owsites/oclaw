...
This directory contains the **BlueBubbles external channel plugin** for OpenWolf.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `openwolf/plugin-sdk` helpers.
