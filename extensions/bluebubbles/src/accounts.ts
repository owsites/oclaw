...
export function listBlueBubblesAccountIds(cfg: OpenWolfConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpenWolfConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpenWolfConfig): ResolvedBlueBubblesAccount[] {
