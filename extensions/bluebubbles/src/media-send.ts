...
import { resolveChannelMediaMaxBytes, type OpenWolfConfig } from "openwolf/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: OpenWolfConfig; accountId?: string }): string[] {
