...
export function listZalouserAccountIds(cfg: OpenWolfConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenWolfConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenWolfConfig, accountId: string): ZalouserAccountConfig {
