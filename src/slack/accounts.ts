...
export function listSlackAccountIds(cfg: OpenWolfConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: OpenWolfConfig): string {
...
function mergeSlackAccountConfig(cfg: OpenWolfConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenWolfConfig): ResolvedSlackAccount[] {
