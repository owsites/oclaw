...
import { type OpenWolfConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenWolfConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenWolfConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenWolfConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenWolfConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OpenWolfConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OpenWolfConfig): GatewaySessionsDefaults {
