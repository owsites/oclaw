...
import type { OpenWolfConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: OpenWolfConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: OpenWolfConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: OpenWolfConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: OpenWolfConfig) => void;
  log: {
