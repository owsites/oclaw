...
export function resolveTtsConfig(cfg: OpenWolfConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.OPENWOLF_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: OpenWolfConfig): string | undefined {
