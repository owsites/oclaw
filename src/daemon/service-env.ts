...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.OPENWOLF_STATE_DIR;
  const configPath = env.OPENWOLF_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    OPENWOLF_PROFILE: profile,
    OPENWOLF_STATE_DIR: stateDir,
    OPENWOLF_CONFIG_PATH: configPath,
    OPENWOLF_GATEWAY_PORT: String(port),
    OPENWOLF_GATEWAY_TOKEN: token,
    OPENWOLF_LAUNCHD_LABEL: resolvedLaunchdLabel,
    OPENWOLF_SYSTEMD_UNIT: systemdUnit,
    OPENWOLF_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    OPENWOLF_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    OPENWOLF_STATE_DIR: stateDir,
    OPENWOLF_CONFIG_PATH: configPath,
    OPENWOLF_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    OPENWOLF_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    OPENWOLF_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    OPENWOLF_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    OPENWOLF_LOG_PREFIX: "node",
    OPENWOLF_SERVICE_MARKER: NODE_SERVICE_MARKER,
    OPENWOLF_SERVICE_KIND: NODE_SERVICE_KIND,
    OPENWOLF_SERVICE_VERSION: VERSION,
  };
}
