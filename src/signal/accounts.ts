...
export function listSignalAccountIds(cfg: OpenWolfConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: OpenWolfConfig): string {
...
function mergeSignalAccountConfig(cfg: OpenWolfConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenWolfConfig): ResolvedSignalAccount[] {
