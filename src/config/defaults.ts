...
function resolveAnthropicDefaultAuthMode(cfg: OpenWolfConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenWolfConfig): OpenWolfConfig {
...
export function applyTalkApiKey(config: OpenWolfConfig): OpenWolfConfig {
...
export function applyModelDefaults(cfg: OpenWolfConfig): OpenWolfConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenWolfConfig): OpenWolfConfig {
...
export function applyLoggingDefaults(cfg: OpenWolfConfig): OpenWolfConfig {
...
export function applyContextPruningDefaults(cfg: OpenWolfConfig): OpenWolfConfig {
...
export function applyCompactionDefaults(cfg: OpenWolfConfig): OpenWolfConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
