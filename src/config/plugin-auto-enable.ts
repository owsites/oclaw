...
function isTelegramConfigured(cfg: OpenWolfConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: OpenWolfConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: OpenWolfConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: OpenWolfConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: OpenWolfConfig): boolean {
...
function isIMessageConfigured(cfg: OpenWolfConfig): boolean {
...
function isWhatsAppConfigured(cfg: OpenWolfConfig): boolean {
...
function isGenericChannelConfigured(cfg: OpenWolfConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: OpenWolfConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: OpenWolfConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: OpenWolfConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: OpenWolfConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: OpenWolfConfig, pluginId: string): OpenWolfConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
