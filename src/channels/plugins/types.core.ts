...
export type ChannelAgentToolFactory = (params: { cfg?: OpenWolfConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenWolfConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenWolfConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenWolfConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenWolfConfig }) => boolean;
