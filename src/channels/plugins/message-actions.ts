...
export function listChannelMessageActions(cfg: OpenWolfConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OpenWolfConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: OpenWolfConfig): boolean {
  for (const plugin of listChannelPlugins()) {
