...
type PromptDefaultModelResult = { model?: string; config?: OpenWolfConfig };
...
function resolveConfiguredModelRaw(cfg: OpenWolfConfig): string {
...
function resolveConfiguredModelKeys(cfg: OpenWolfConfig): string[] {
...
export function applyPrimaryModel(cfg: OpenWolfConfig, model: string): OpenWolfConfig {
...
export function applyModelAllowlist(cfg: OpenWolfConfig, models: string[]): OpenWolfConfig {
  const defaults = cfg.agents?.defaults;
