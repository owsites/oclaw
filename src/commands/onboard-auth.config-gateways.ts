...
export function applyVercelAiGatewayProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
...
export function applyVercelAiGatewayConfig(cfg: OpenWolfConfig): OpenWolfConfig {
