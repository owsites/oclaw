...
function resolveDefaultAccountId(cfg: OpenWolfConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenWolfConfig): boolean {
...
export function summarizeBindings(cfg: OpenWolfConfig, bindings: AgentBinding[]): string[] {
