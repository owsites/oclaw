...
export function applyOpenrouterProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OpenWolfConfig): OpenWolfConfig {
...
export function applyMoonshotConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: OpenWolfConfig): OpenWolfConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenWolfConfig): OpenWolfConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenWolfConfig): OpenWolfConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: OpenWolfConfig): OpenWolfConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OpenWolfConfig): OpenWolfConfig {
...
export function applyQianfanProviderConfig(cfg: OpenWolfConfig): OpenWolfConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OpenWolfConfig): OpenWolfConfig {
