...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "openwolf-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpenWolfConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpenWolfConfig["telegram"]>>,
