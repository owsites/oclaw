...
export const A2UI_PATH = "/__openwolf__/a2ui";

export const CANVAS_HOST_PATH = "/__openwolf__/canvas";

export const CANVAS_WS_PATH = "/__openwolf__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openwolfCanvasA2UIAction.postMessage(...)
  // - Android: window.openwolfCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openwolfCanvasA2UIAction"];
  ...
  globalThis.OpenWolf = globalThis.OpenWolf ?? {};
  globalThis.OpenWolf.postMessage = postToNode;
  globalThis.OpenWolf.sendUserAction = sendUserAction;
  globalThis.openwolfPostMessage = postToNode;
  globalThis.openwolfSendUserAction = sendUserAction;
