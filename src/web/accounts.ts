...
export function listWhatsAppAuthDirs(cfg: OpenWolfConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenWolfConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OpenWolfConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OpenWolfConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenWolfConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenWolfConfig): ResolvedWhatsAppAccount[] {
