...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OpenWolfConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OpenWolfConfig; env: NodeJS.ProcessEnv }): {
  cfg: OpenWolfConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
