...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @openwolf/voice-call -> voice-call).
...
export function discoverOpenWolfPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".openwolf", "extensions")];
