...
const loadOpenWolfPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadOpenWolfPlugins: (params: unknown) => loadOpenWolfPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadOpenWolfPluginsMock.mockReturnValue(registry);
  return registry;
}

describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadOpenWolfPluginsMock.mockReset();
  });
