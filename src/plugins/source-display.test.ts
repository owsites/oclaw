...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/openwolf/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openwolf/extensions",
        global: "/Users/x/.openwolf/extensions",
        workspace: "/Users/x/ws/.openwolf/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.openwolf/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openwolf/extensions",
        global: "/Users/x/.openwolf/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.openwolf/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openwolf/extensions",
        global: "/Users/x/.openwolf/extensions",
