...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OpenWolfConfig | null = null;
  ...
  get(key: string, cfg: OpenWolfConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OpenWolfConfig): void {
    this.resetIfConfigChanged(cfg);
    const now = Date.now();
  ...
  private resetIfConfigChanged(cfg: OpenWolfConfig): void {
