...
export function listIMessageAccountIds(cfg: OpenWolfConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: OpenWolfConfig): string {
...
function mergeIMessageAccountConfig(cfg: OpenWolfConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpenWolfConfig): ResolvedIMessageAccount[] {
