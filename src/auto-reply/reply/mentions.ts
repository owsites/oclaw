...
function resolveMentionPatterns(cfg: OpenWolfConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenWolfConfig | undefined, agentId?: string): RegExp[] {
