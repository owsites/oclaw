...
function resolveForegroundMs(cfg: OpenWolfConfig): number {
...
export async function handleBashChatCommand(params: {
  ...
  if (params.cfg.commands?.bash !== true) {
    return {
      text: "⚠️ bash is disabled. Set commands.bash=true to enable. Docs: https://docs.openwolf.ai/tools/slash-commands#config",
    };
  }
