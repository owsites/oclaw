...
export function isCommandEnabled(cfg: OpenWolfConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: OpenWolfConfig): {
  provider: string;
  model: string;
} {
  const resolved = resolveConfiguredModelRef({
    cfg: cfg ?? ({} as OpenWolfConfig),
...
export function getCommandDetection(_cfg?: OpenWolfConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: OpenWolfConfig) {
