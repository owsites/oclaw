...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openwolf", { botUsername: "openwolf" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openwolf args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openwolf" })).toBe(
      "/help@otherbot",
    );
  });
