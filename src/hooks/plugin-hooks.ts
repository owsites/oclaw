...
import type { OpenWolfPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpenWolfPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpenWolfPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
