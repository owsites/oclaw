...
export function resolveSessionToolsVisibility(cfg: OpenWolfConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: OpenWolfConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: OpenWolfConfig): AgentToAgentPolicy {
