...
export function listAgentIds(cfg: OpenWolfConfig): string[] {
...
export function resolveDefaultAgentId(cfg: OpenWolfConfig): string {
  const agents = listAgents(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
export function resolveSessionAgentIds(params: { sessionKey?: string; config?: OpenWolfConfig }): {
...
export function resolveAgentModelPrimary(cfg: OpenWolfConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: OpenWolfConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: OpenWolfConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
