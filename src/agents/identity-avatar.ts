...
function resolveAvatarSource(cfg: OpenWolfConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenWolfConfig, agentId: string): AgentAvatarResolution {
