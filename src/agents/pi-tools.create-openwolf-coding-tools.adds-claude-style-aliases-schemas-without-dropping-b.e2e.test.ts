...
describe("createOpenWolfCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOpenWolfCodingTools({
      config,
    ...
    const anthropicTools = createOpenWolfCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpenWolfCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpenWolfCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
