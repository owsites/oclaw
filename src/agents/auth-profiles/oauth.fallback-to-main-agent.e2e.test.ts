...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenWolfAgentDir() returns mainAgentDir
    process.env.OPENWOLF_STATE_DIR = tmpDir;
    process.env.OPENWOLF_AGENT_DIR = mainAgentDir;
