...
function resolveWatchPaths(workspaceDir: string, config?: OpenWolfConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OpenWolfConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenWolfConfig }) {
