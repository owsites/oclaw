...
export const DEFAULT_SANDBOX_IMAGE = "openwolf-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openwolf-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openwolf-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openwolf-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openwolf-sbx-browser-";
