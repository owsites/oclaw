...
import type { OpenWolfConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: OpenWolfConfig, agentId: string) {
  try {
