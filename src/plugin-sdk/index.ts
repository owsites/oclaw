...
export type { OpenWolfConfig } from "../config/config.js";
/** @deprecated Use OpenWolfConfig instead */
export type { OpenWolfConfig as WolfbotConfig } from "../config/config.js";
