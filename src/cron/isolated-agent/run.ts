...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/openwolf/openwolf/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.OPENWOLF_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.openwolf/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: OpenWolfConfig = {
    ...params.cfg,
