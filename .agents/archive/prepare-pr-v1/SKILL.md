...
- `fix: <summary> (openwolf#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (openwolf#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "openwolf#$pr_number" || { echo "ERROR: commit subject missing openwolf#$pr_number"; exit 1; }
