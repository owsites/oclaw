## OpenWolf Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_openwolf-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm openwolf gateway --port 18789 --verbose
```
