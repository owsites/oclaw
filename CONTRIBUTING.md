...
- **GitHub:** https://github.com/openwolf/openwolf
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@openwolf](https://x.com/openwolf)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/openwolf/openwolf/discussions) or ask in Discord first
3. **Questions** → Discord #setup-help

## Before You PR

- Test locally with your OpenWolf instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://wolfhub.ai/) — the community hub for OpenWolf skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/openwolf/openwolf/issues) for "good first issue" labels!
