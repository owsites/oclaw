...
- Install via CLI: `openwolf plugins install @openwolf/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `openwolf plugins install ./extensions/zalo`
   - From npm (if published): `openwolf plugins install @openwolf/zalo`
...
- Approve via:
  - `openwolf pairing list zalo`
  - `openwolf pairing approve zalo <CODE>`
...
- Example: `openwolf message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `openwolf channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `openwolf logs --follow`
