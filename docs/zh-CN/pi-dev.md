...
本指南总结了在 OpenWolf 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenWolf 状态目录下。默认为 `~/.openwolf`。如果设置了 `OPENWOLF_STATE_DIR`，则使用该目录。
...
- https://docs.openwolf.ai/testing
- https://docs.openwolf.ai/start/getting-started
