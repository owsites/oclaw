---
summary: "Overview of OpenWolf onboarding options and flows"
read_when:
...
OpenWolf supports multiple onboarding paths depending on where the Gateway runs
...
- [`openwolf onboard` command](/cli/onboard)

## macOS app onboarding

Use the OpenWolf app when you want a fully guided setup on macOS. Docs:
