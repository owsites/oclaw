---
summary: "First-run onboarding flow for OpenWolf (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenWolf">
...
<Step title="CLI">
  ...
  The app can install the global `openwolf` CLI via npm/pnpm so terminal
