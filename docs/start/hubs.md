---
summary: "Hubs that link to every OpenWolf doc"
read_when:
...
<Note>
If you are new to OpenWolf, start with [Getting Started](/start/getting-started).
</Note>
...
- [OpenWolf assistant](/start/openwolf)
