...
- Same path: run the app from a fixed location (for OpenWolf, `dist/OpenWolf.app`).
...
Workaround: move files into the OpenWolf workspace (`~/.openwolf/workspace`) if you want to avoid per-folder grants.
