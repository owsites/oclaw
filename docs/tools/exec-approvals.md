...
- **gateway host** → `openwolf` process on the gateway machine
...
`~/.openwolf/exec-approvals.json` directly.

CLI: `openwolf approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
