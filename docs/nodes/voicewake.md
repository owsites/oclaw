...
OpenWolf treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.openwolf/settings/voicewake.json`

Shape:

```json
{ "triggers": ["openwolf", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
