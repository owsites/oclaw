...
read_when:
  - You are building a OpenWolf plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (openwolf.plugin.json)

Every plugin **must** ship a `openwolf.plugin.json` file in the **plugin root**.
OpenWolf uses this manifest to validate configuration **without executing plugin
