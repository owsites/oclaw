---
summary: "Use Synthetic's Anthropic-compatible API in OpenWolf"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OpenWolf registers it as the
...
Note: OpenWolf's Anthropic client appends `/v1` to the base URL, so use
