---
summary: "Use Qwen OAuth (free tier) in OpenWolf"
read_when:
  - You want to use Qwen with OpenWolf
...
If you already logged in with the Qwen Code CLI, OpenWolf will sync credentials
