---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenWolf"
read_when:
  - You want Xiaomi MiMo models in OpenWolf
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenWolf uses
