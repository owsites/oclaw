---
summary: "Use Qianfan's unified API to access many models in OpenWolf"
read_when:
...
3. OpenWolf installed on your system
...
4. Copy the API key for use with OpenWolf

## CLI setup

```bash
openwolf onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenWolf Configuration](/gateway/configuration)
