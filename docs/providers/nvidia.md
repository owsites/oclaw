---
summary: "Use NVIDIA's OpenAI-compatible API in OpenWolf"
read_when:
  - You want to use NVIDIA models in OpenWolf
...
openwolf onboard --auth-choice skip
openwolf models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
