...
read_when:
  ...
  - Wiring external systems into OpenWolf
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your OpenWolf config directory (typically `~/.openwolf/hooks/transforms`).
...
- `openwolf webhooks gmail setup` writes `hooks.gmail` config for `openwolf webhooks gmail run`.
