...
Deploy OpenWolf on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/wolfbot-railway-template" target="_blank" rel="noreferrer">
  Deploy on Railway
</a>
...
- `https://<your-railway-domain>/openwolf` — Control UI

## What you get

- Hosted OpenWolf Gateway + Control UI
...
- `OPENWOLF_STATE_DIR=/data/.openwolf` (recommended)
- `OPENWOLF_WORKSPACE_DIR=/data/workspace` (recommended)
- `OPENWOLF_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your OpenWolf state + workspace so you can migrate to another host without losing config or memory.
