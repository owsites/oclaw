...
This guide summarizes a sane workflow for working on the pi integration in OpenWolf.
...
- Trigger the agent directly:
  - `pnpm openwolf agent --message "Hello" --thinking low`
...
State lives under the OpenWolf state directory. Default is `~/.openwolf`. If `OPENWOLF_STATE_DIR` is set, use that directory instead.

To reset everything:

- `openwolf.json` for config
...
- [https://docs.openwolf.ai/testing](https://docs.openwolf.ai/testing)
- [https://docs.openwolf.ai/start/getting-started](https://docs.openwolf.ai/start/getting-started)
