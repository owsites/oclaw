...
show_usage() {
    cat << EOF
clawlog - OpenWolf Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View OpenWolf logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    OpenWolf logs flow through the macOS unified log (subsystem: ai.openwolf).
