...
- Keep product names in English: OpenWolf, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the OpenWolf Gateway, use “Gateway 网关”.
