...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenWolf $VERSION</h2>"
  echo "<p>Latest OpenWolf update.</p>"
  echo "<p><a href=\"https://github.com/openwolf/openwolf/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
