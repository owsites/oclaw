...
# Output:
# - dist/OpenWolf.app
# - dist/OpenWolf-<version>.zip
# - dist/OpenWolf-<version>.dmg
...
APP="$ROOT_DIR/dist/OpenWolf.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenWolf-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenWolf-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenWolf-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenWolf-$VERSION.dSYM.zip"
