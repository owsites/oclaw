...
# Defaults target the OpenWolf assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/OpenWolf/Resources/OpenWolf.icns"}
